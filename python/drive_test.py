...
def mar30course(robot):
  robot.drive_to_cone(1.5, 33.77863333333333, 118.41894166666667)
  robot.drive_to_waypoint(1.5, 33.778418333333335, 118.41889)
  robot.drive_to_cone(1.5, 33.778531666666666, 118.419085)
  robot.drive_to_cone(1.5, 33.77863333333333, 118.41894166666667)
  robot.drive_to_waypoint(1.5, 33.778571666666664, 118.41876)

def apr3course(robot):
  robot.drive_to_cone(1.5, 33.77863833333333, 118.41891833333334, 1580)
  robot.drive_to_cone(1.5, 33.778345, 118.41901833333333)
  robot.drive_to_cone(1.5, 33.77863833333333, 118.41891833333334)
  robot.drive_to_waypoint(1.5, 33.77857, 118.41875833333333)

def dec12course(robot):
  robot.drive_to_cone(1.5, 33.77813166666667, 118.41887333333334)
  robot.drive_to_cone(1.5, 33.77825833333333, 118.41907666666667)
#========================================================
